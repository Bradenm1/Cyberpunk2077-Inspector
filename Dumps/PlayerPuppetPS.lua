{
	...
	functions: {
		HasAutoReveal() => (Bool),
		SetAutoReveal(value: Bool),
		OnStoreMinigameProgram(evt: handle:StoreMiniGameProgramEvent) => (EntityNotificationType),
		AddMinigameProgram(program: gameuiMinigameProgramData),
		RemoveMinigameProgram(program: gameuiMinigameProgramData),
		RemoveProgram(id: TweakDBID),
		HasProgram(id: TweakDBID) => (Bool),
		UpgradePrograms(id: TweakDBID),
		DecideProgramToAdd(id: TweakDBID) => (gameuiMinigameProgramData),
		GetMinigameBlackboard() => (handle:gameIBlackboard),
		GetMinigamePrograms() => (array:gameuiMinigameProgramData),
		HasProgram(id: TweakDBID, programs: array:gameuiMinigameProgramData) => (Bool),
		OnInstantiated() => (Bool),
		Initialize(),
		IsInitialized() => (Bool),
		WasAttached() => (Bool),
