{
	name: VehicleComponentPS,
	functions: {
		GetVehicleControllerPS() => (handle:vehicleControllerPS),
		GetVehicleControllerPSConst() => (handle:vehicleControllerPS),
		Initialize(),
		GameAttached(),
		GetOwnerEntity() => (whandle:vehicleBaseObject),
		GetHasDefaultStateBeenSet() => (Bool),
		SetHasDefaultStateBeenSet(set: Bool),
		GetHasStateBeenModifiedByQuest() => (Bool),
		GetNpcOccupiedSlots() => (array:CName),
		GetIsDestroyed() => (Bool),
		SetIsDestroyed(value: Bool),
		GetIsStolen() => (Bool),
		SetIsStolen(value: Bool),
		SetHasStateBeenModifiedByQuest(set: Bool),
		GetIsPlayerVehicle() => (Bool),
		SetIsPlayerVehicle(set: Bool),
		GetIsCrystalDomeQuestModified() => (Bool),
		SetIsCrystalDomeQuestModified(value: Bool),
		GetCrystalDomeQuestState() => (Bool),
		SetCrystalDomeQuestState(value: Bool),
		GetCrystalDomeState() => (Bool),
		SetCrystalDomeState(value: Bool),
		GetIsUiQuestModified() => (Bool),
		SetIsUiQuestModified(value: Bool),
		GetUiQuestState() => (Bool),
		SetUiQuestState(value: Bool),
		GetSirenState() => (Bool),
		SetSirenState(value: Bool),
		GetSirenLightsState() => (Bool),
		SetSirenLightsState(value: Bool),
		GetSirenSoundsState() => (Bool),
		SetSirenSoundsState(value: Bool),
		GetHasVisualDestructionBeenSet() => (Bool),
		SetHasVisualDestructionBeenSet(set: Bool),
		GetHasExploded() => (Bool),
		SetHasExploded(set: Bool),
		GetHasAnyDoorOpen() => (Bool),
		SetHasAnyDoorOpen(set: Bool),
		GetThrusterState() => (Bool),
		SetThrusterState(set: Bool),
		OnToggleVehicle(evt: handle:ToggleVehicle) => (EntityNotificationType),
		OnForceCarAlarm(evt: handle:ForceCarAlarm) => (EntityNotificationType),
		OnForceDisableCarAlarm(evt: handle:ForceDisableCarAlarm) => (EntityNotificationType),
		DisableAlarm(),
		InitializeTempDoorStateStruct(),
		InitializeDoorInteractionState(),
		RefreshSkillchecks(),
		ChangeToActionContext(vehicleContext: VehicleActionsContext) => (gameGetActionsContext),
		SetDoorState(door: vehicleEVehicleDoor, state: vehicleVehicleDoorState),
		GetDoorState(door: vehicleEVehicleDoor) => (vehicleVehicleDoorState),
		SetWindowState(door: vehicleEVehicleDoor, state: vehicleEVehicleWindowState),
		GetWindowState(door: vehicleEVehicleDoor) => (vehicleEVehicleWindowState),
		SetDoorInteractionState(door: vehicleEVehicleDoor, state: vehicleVehicleDoorInteractionState, source: String),
		GetDoorInteractionState(door: vehicleEVehicleDoor) => (vehicleVehicleDoorInteractionState),
		SetTempDoorInteractionState(door: vehicleEVehicleDoor, state: vehicleVehicleDoorInteractionState),
		GetTempDoorInteractionState(door: vehicleEVehicleDoor) => (vehicleVehicleDoorInteractionState),
		GetVehicleDoorEnum(doorName: CName) => (Bool, door: vehicleEVehicleDoor),
		OnVehicleDoorInteraction(evt: handle:VehicleDoorInteraction) => (EntityNotificationType),
		OnVehicleForceOccupantOut(evt: handle:VehicleForceOccupantOut) => (EntityNotificationType),
		...
		OnVehicleDoorOpen(evt: handle:VehicleDoorOpen) => (EntityNotificationType),
		OnVehicleDoorClose(evt: handle:VehicleDoorClose) => (EntityNotificationType),
		OnVehicleDoorInteractionStateChange(evt: handle:VehicleDoorInteractionStateChange) => (EntityNotificationType),
		GetQuestLockedActions(context: VehicleActionsContext) => (actions: array:handle:gamedeviceAction),
		IsStateValidForVehicle(state: vehicleVehicleDoorInteractionState) => (Bool),
		OnVehicleWindowOpen(evt: handle:VehicleWindowOpen) => (EntityNotificationType),
		OnVehicleWindowClose(evt: handle:VehicleWindowClose) => (EntityNotificationType),
		OnOpenTrunk(evt: handle:VehicleOpenTrunk) => (EntityNotificationType),
		OnCloseTrunk(evt: handle:VehicleCloseTrunk) => (EntityNotificationType),
		OnVehicleDumpBody(evt: handle:VehicleDumpBody) => (EntityNotificationType),
		OnVehicleTakeBody(evt: handle:VehicleTakeBody) => (EntityNotificationType),
		ProcessBodyDisposalEvent(),
		OnVehicleBodyDisposalPerformedEvent(evt: handle:VehicleBodyDisposalPerformedEvent) => (EntityNotificationType),
		OnVehiclePlayerTrunk(evt: handle:VehiclePlayerTrunk) => (EntityNotificationType),
		GetTrunkActions(context: VehicleActionsContext) => (actions: array:handle:gamedeviceAction),
		IsPlayerCarryingBody(includePickupPhase: Bool) => (Bool),
		GetPlayerTrunkActions(context: VehicleActionsContext) => (actions: array:handle:gamedeviceAction),
		OnOpenHood(evt: handle:VehicleOpenHood) => (EntityNotificationType),
		OnCloseHood(evt: handle:VehicleCloseHood) => (EntityNotificationType),
		GetHoodActions(context: VehicleActionsContext) => (actions: array:handle:gamedeviceAction),
		DetermineActionsToPush(interaction: handle:gameinteractionsComponent, context: VehicleActionsContext, objectActionsCallbackController: whandle:gameObjectActionsCallbackController, isAutoRefresh: Bool),
		IsDoorLayer(layer: CName) => (Bool),
		GetValidChoices(objectActionRecords: array:whandle:gamedataObjectAction_Record, context: gameGetActionsContext, objectActionsCallbackController: whandle:gameObjectActionsCallbackController, isAutoRefresh: Bool) => (choices: array:gameinteractionsChoice),
		PushActionsToInteractionComponent(interaction: handle:gameinteractionsComponent, choices: array:gameinteractionsChoice, context: VehicleActionsContext),
		OnVehicleFinishedMounting(evt: handle:vehicleFinishedMountingEvent) => (EntityNotificationType),
		OnVehicleStartedUnmountingEvent(evt: handle:VehicleStartedUnmountingEvent) => (EntityNotificationType),
		...
		GetQuickHackActions(context: gameGetActionsContext) => (actions: array:handle:gamedeviceAction),
		ActionForceCarAlarm() => (handle:ForceCarAlarm),
		ActionForceDisableCarAlarm() => (handle:ForceDisableCarAlarm),
		ActionToggleVehicle(toggleOn: Bool) => (handle:ToggleVehicle),
		ActionOpenTrunk() => (handle:VehicleOpenTrunk),
		ActionCloseTrunk() => (handle:VehicleCloseTrunk),
		ActionOpenHood() => (handle:VehicleOpenHood),
		ActionCloseHood() => (handle:VehicleCloseHood),
		ActionVehicleDumpBody() => (handle:VehicleDumpBody),
		ActionVehicleTakeBody() => (handle:VehicleTakeBody),
		ActionPlayerTrunk() => (handle:VehiclePlayerTrunk),
		ActionVehicleDoorInteraction(slotName: String, fromInteraction: Bool, locked: Bool) => (handle:VehicleDoorInteraction),
		ActionVehicleDoorInteractionStateChange(doorToChange: vehicleEVehicleDoor, desiredState: vehicleVehicleDoorInteractionState, source: String) => (handle:VehicleDoorInteractionStateChange),
		ActionVehicleDoorOpen(slotName: String) => (handle:VehicleDoorOpen),
		ActionVehicleDoorClose(slotName: String) => (handle:VehicleDoorClose),
		ActionVehicleForceOccupantOut(slotName: String) => (handle:VehicleForceOccupantOut),
		ActionVehicleDoorQuestLocked() => (handle:VehicleQuestDoorLocked),
		OnVehicleQuestChangeDoorStateEvent(evt: handle:VehicleQuestChangeDoorStateEvent) => (EntityNotificationType),
		OnVehicleQuestChangeWindowStateEvent(evt: handle:vehicleChangeWindowStateEvent) => (EntityNotificationType),
		OnToggleDoorWrapperEvent(evt: handle:vehicleToggleDoorWrapperEvent) => (EntityNotificationType),
		OpenAllVehDoors(),
		OpenAllRegularVehDoors(),
		CloseAllVehDoors(),
		LockAllVehDoors(),
		UnlockAllVehDoors(),
		OpenAllVehWindows(),
		...
		OnVehicleSeatReservationEvent(evt: handle:VehicleSeatReservationEvent) => (EntityNotificationType),
		GetSeats() => (array:whandle:gamedataVehicleSeat_Record),
		OnVehicleQuestCrystalDomeEvent(evt: handle:VehicleQuestCrystalDomeEvent) => (EntityNotificationType),
		OnVehicleQuestSirenEvent(evt: handle:VehicleQuestSirenEvent) => (EntityNotificationType),
		OnVehicleLightQuestToggleEvent(evt: handle:VehicleLightQuestToggleEvent) => (EntityNotificationType),
		OnVehicleQuestHornEvent(evt: handle:VehicleQuestHornEvent) => (EntityNotificationType),
		OnVehicleQuestVisualDestructionEvent(evt: handle:VehicleQuestVisualDestructionEvent) => (EntityNotificationType),
		OnVehicleQuestAVThrusterEvent(evt: handle:VehicleQuestAVThrusterEvent) => (EntityNotificationType),
		OnVehicleQuestUIEvent(evt: handle:VehicleQuestEnableUIEvent) => (EntityNotificationType),
		OnVehicleQuestUIEffectEvent(evt: handle:VehicleQuestUIEffectEvent) => (EntityNotificationType),
		OnVehicleRadioEvent(evt: handle:VehicleRadioEvent) => (EntityNotificationType),
		OnVehicleQuestWindowDestructionEvent(evt: handle:VehicleQuestWindowDestructionEvent) => (EntityNotificationType),
		OnVehicleRaceQuestEvent(evt: handle:VehicleRaceQuestEvent) => (EntityNotificationType),
		OnVehiclePanzerBootupUIQuestEvent(evt: handle:VehiclePanzerBootupUIQuestEvent) => (EntityNotificationType),
		OnVehicleQuestToggleEngineEvent(evt: handle:VehicleQuestToggleEngineEvent) => (EntityNotificationType),
		OnInstantiated() => (Bool),
	...
	properties: {
		...
		stateModifiedByQuest: Bool,
		playerVehicle: Bool,
		npcOccupiedSlots: array:CName,
		isDestroyed: Bool,
		isStolen: Bool,
		crystalDomeQuestModified: Bool,
		crystalDomeQuestState: Bool,
		crystalDomeState: Bool,
		visualDestructionSet: Bool,
		visualDestructionNeeded: Bool,
		exploded: Bool,
		sirenOn: Bool,
		sirenSoundOn: Bool,
		sirenLightsOn: Bool,
		anyDoorOpen: Bool,
		previousInteractionState: array:TemporaryDoorState,
		thrusterState: Bool,
		uiQuestModified: Bool,
		uiState: Bool,
		vehicleSkillChecks: handle:EngDemoContainer,
		ready: Bool,
		isPlayerPerformingBodyDisposal: Bool,
		vehicleControllerPS: handle:vehicleControllerPS,
		isInitialized: Bool,
