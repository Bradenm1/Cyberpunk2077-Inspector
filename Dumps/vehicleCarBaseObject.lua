{
	...
	functions: {
		...
		ToggleHorn(toggle: Bool, isPolice: Bool),
		...
		ForceBrakesUntilStoppedOrFor(secondsToTimeout: Float),
		...
		CanUnmount(isPlayer: Bool, mountedObject: whandle:gameObject, checkSpecificDirection: vehicleExitDirection) => (vehicleUnmountPosition),
		GetController() => (handle:vehicleController),
		...
		ResendHandleReactionEvent(evt: handle:HandleReactionEvent),
